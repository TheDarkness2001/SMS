...
export const homeworkAPI = {
  ...
  getLessonStudentStats: (lessonId) => api.get(`/homework/lessons/${lessonId}/student-stats`),
...
export const lessonAPI = {
  ...
  deleteLesson: (id, params) => api.delete(`/homework/lessons/${id}`, { params, data: params }),
